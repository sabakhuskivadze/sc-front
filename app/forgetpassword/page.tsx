...
const [search,setSearch] = useState<string>()
    ...
    const [forget, setFotget] = useState<boolean>(true);
        ...
        <>
          ...
          {forget &&
              ...
              <div className={styles.loginCard}>
                  ...
                  <div className={styles.loginCrdItem}>
                      ...
                      <div className={styles.container}>
                          ...
                          <div className={styles.continerGroup}>
                              <svg className={styles.TextPhoto} width="501" height="18" viewBox="0 0 501 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p onClick={login1} className={styles.text}>არ გაქვთ ექაუნთი? <span className={styles.sp1}>დარექისტრირდი</span></p>
              </div>
          </div>
